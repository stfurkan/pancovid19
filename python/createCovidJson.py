...
confirmedCsv = open(fileDir + '/datasets/time_series_covid19_confirmed_global.csv')
...
recoveredCsv = open(fileDir + '/datasets/time_series_covid19_recovered_global.csv')
